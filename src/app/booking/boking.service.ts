...
import { TktService } from '../ticket/tkt.service';
...
export class BokingService {
  ...
  getTotalCost(bookingId: any): Observable<Booking> {
    return this.httpClient
      .get<Booking>(this.url + '/booking/cost/' + bookingId)
      .pipe(catchError(this.handleError));
  }
